...
interface TrainingBackground {
  ...
  primary_goals: Array<
    "fitness" | "recreation" | "competition" | "professional"
  >;
}
```
...
interface CurrentChallenges {
  injury_history?: Array<
    "none" | "knee-ankle" | "shoulder-elbow" | "back" | "multiple"
  >;
  biggest_challenge?:
    | "power"
    | "endurance"
...
interface PersonalizationData {
  favorite_players?: Array<
    "djokovic" | "alcaraz" | "sinner" | "medvedev" | "other"
  >;
...
- **Tennis Branding**: Consistent with Tenis Manual theme
...
This specification serves as the comprehensive guide for implementing a world-class onboarding experience that transforms casual visitors into highly engaged Tenis Manual community members.
