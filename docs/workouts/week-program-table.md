...
### 📅 Saturday - Competition or Recovery
...
### 📅 Tuesday - Upper Body Power & Tennis
...
| Time | Activity | Duration | Details |
|------|----------|----------|---------|
| 8:00-8:30 | Recovery Swim | 30 min | Easy pace, focus on breathing |
| 8:30-9:00 | Sports Massage | 30 min | Professional or self-massage |
| 9:00-9:30 | Contrast Therapy | 30 min | 3×3 min hot/cold (if available) |
| 9:30-10:00 | Light Stretching | 30 min | Full body flexibility work |

### 📅 Sunday - Complete Rest

| Time | Activity | Duration | Details |
|------|----------|----------|---------|
| 8:00-8:30 | Light Walk | 30 min | Nature walk, easy pace |
| 8:30-8:50 | Meditation | 20 min | Guided or mindfulness practice |
| Morning | Meal Prep | 2 hours | Prepare healthy meals for week |
| Afternoon | Recovery | - | Complete rest, leisure activities |
| Evening | Sleep Prep | - | Target 8-9 hours quality sleep |

---

**Week 2 Key Performance Indicators:**
- Volume: 15% increase from Week 1 (480 AU)
- Intensity: 70-80% average
- VBT Zones: 0.8-0.85 m/s focus
- Tennis Volume: 7.5 hours
- Gym Volume: 7.5 hours
| **Week 3** | Lower Body Explosive & Tennis<br/>• Tennis: Movement (90 min)<br/>• Jump Squat (5×3 @30%)<br/>• Heavy Squats (5×5 @85%)<br/>• Depth Jumps (4×3)<br/>• RFD Focus 0-100ms | Upper Body Explosive & Tennis<br/>• Tennis: Serve Power (90 min)<br/>• Explosive Push-ups (5×3)<br/>• Heavy Bench (5×5 @85%)<br/>• Speed Pulls (4×3)<br/>• VBT: 0.9-1.0 m/s | Power Endurance & Tennis<br/>• Competitive Sets (90 min)<br/>• Complex Circuit (5 rounds)<br/>• Battle Ropes (6×20s)<br/>• Core Power (Nadal)<br/>• Lactate Threshold | Active Recovery & Tennis<br/>• Technical Work (60 min)<br/>• Light Cardio Z2 (30 min)<br/>• PNF Stretching<br/>• 4-7-8 Breathing | Total Body Power & Tennis<br/>• Tennis Integration (90 min)<br/>• Power Clean (5×3 @80%)<br/>• Complex Training<br/>• Med Ball Finishers<br/>• Neural Drive Max | Tournament Prep<br/>• Match Simulation (2h)<br/>• Mental Training<br/>• Video Analysis<br/>• Recovery Protocols | Rest & Planning<br/>• Performance Review<br/>• Set Week 4 Goals<br/>• Full Recovery<br/>• HRV Assessment |

### Phase 2: Power Development (Weeks 4-6)

| Week | Monday | Tuesday | Wednesday | Thursday | Friday | Saturday | Sunday |
|------|---------|---------|-----------|----------|---------|----------|---------|
| **Week 4 (Deload)** | Recovery Tennis & Movement<br/>• Technical Drills (45 min)<br/>• Bodyweight Squats (2×15)<br/>• Light Mobility (20 min)<br/>• Core Stability (2 sets)<br/>•40-50% Volume | Light Upper & Tennis<br/>• Serve Technique (45 min)<br/>• Light Press (3×10 @50%)<br/>• Band Work (100 reps)<br/>• PNF Stretching<br/>• Recovery Focus | Recovery Circuit & Tennis<br/>• Easy Rally (30 min)<br/>• Light Circuit (2 rounds)<br/>• Djokovic Yoga (20 min)<br/>• 4-7-8 Breathing<br/>• Neural Reset | Zone 2 & Flexibility<br/>• Easy Bike (45 min @Z2)<br/>• Full Body Stretch (30 min)<br/>• Sports Massage<br/>• Contrast Therapy | Assessment & Planning<br/>• Movement Screen (FMS)<br/>• Power Tests (CMJ, RSI)<br/>• Program Review<br/>• Goal Setting Week 5-6<br/>• HRV Analysis | Optional Light Play<br/>• Fun Tennis (60 min)<br/>• Social Match<br/>• Recovery Swim<br/>• Sauna Session | Complete Rest<br/>• No Training<br/>• Mental Reset<br/>• Meal Prep<br/>• Sleep 9+ hours |
| **Week 5** | Heavy Lower & Tennis<br/>• Power Groundstrokes (90 min)<br/>• Squat (5×3 @85% 1RM)<br/>• Box Jumps (5×3 @50cm)<br/>• Heavy RDL (4×5 @85%)<br/>• PAP Complex | Heavy Upper & Tennis<br/>• Serve Velocity (90 min)<br/>• Bench (5×3 @85% 1RM)<br/>• Weighted Pull-ups (+20kg)<br/>• Power Snatch (4×3)<br/>• VBT: 0.6-0.75 m/s | Speed-Strength & HIIT<br/>• Match Intensity (75 min)<br/>• Power Clean (5×3 @70%)<br/>• Plyometrics (4 sets)<br/>• 10m Sprints (8×)<br/>• Lactate Power | Recovery & Control<br/>• Touch Tennis (45 min)<br/>• Light Cardio Z2 (40 min)<br/>• Mobility Work (30 min)<br/>• Core Stability<br/>• HRV Check | Complex Training & Tennis<br/>• Transitions (90 min)<br/>• Heavy Squat + Jump (5 sets)<br/>• Med Ball Power (6×3)<br/>• Agility Ladders<br/>• Murray 6×5 System | Competition or Test<br/>• Tournament Play<br/>• Power Testing:<br/>• - CMJ, RSI<br/>• - Serve Speed<br/>• - Sprint Times | Active Recovery<br/>• Light Tennis (45 min)<br/>• Stretching (30 min)<br/>• Week 6 Planning<br/>• Nutrition Focus |
| **Week 6** | Max Strength & Tennis<br/>• Baseline Power (90 min)<br/>• Squat (3×2 @90% 1RM)<br/>• Depth Jumps (5×2 @60cm)<br/>• Heavy DL (3×2 @90%)<br/>• Neural Max | Upper Max & Tennis<br/>• Serve Records (90 min)<br/>• Bench (3×2 @90% 1RM)<br/>• Explosive Rows (5×3)<br/>• Rotator Cuff Prehab<br/>• VBT: 0.5-0.6 m/s | Competition Prep<br/>• Match Simulation (2h)<br/>• Power Circuits (4 rounds)<br/>• React Training (20 min)<br/>• Mental Prep (30 min)<br/>• Pressure Drills | Technical & Recovery<br/>• Fine Tuning (60 min)<br/>• Light Movement (30 min)<br/>• Deep Tissue Massage<br/>• Breathing Protocols<br/>• Video Analysis | Pre-Competition<br/>• Light Tennis (45 min)<br/>• CNS Activation<br/>• Visualization (20 min)<br/>• Strategy Session<br/>• Equipment Check | Tournament/Testing<br/>• Competition Play<br/>• Peak Performance<br/>• Record All Results:<br/>• - Match Stats<br/>• - Physical Tests | Recovery<br/>• Phase Assessment<br/>• Week 7-9 Planning<br/>• Full Rest Day<br/>• HRV Recovery |

### Phase 3: Elite Integration (Weeks 7-9)

| Week | Monday | Tuesday | Wednesday | Thursday | Friday | Saturday | Sunday |
|------|---------|---------|-----------|----------|---------|----------|---------|
| **Week 7** | Power Conversion & Tennis<br/>• Reactive Drills (90 min)<br/>• Jump Training (6 sets)<br/>• Speed Squats (8×3 @60%)<br/>• Plyometrics Complex<br/>• RFD Maximum | Reactive Upper & Tennis<br/>• Quick Serves (90 min)<br/>• Plyo Push-ups (6×3)<br/>• Speed Bench (8×3 @60%)<br/>• Reactive MB Throws<br/>• VBT: >1.0 m/s | Speed Endurance<br/>• Rally Intensity (90 min)<br/>• Repeated Sprints (10×20m)<br/>• Power Circuits (5 rounds)<br/>• Alactic Power<br/>• Neural Fatigue | Recovery & Skills<br/>• Technical Work (60 min)<br/>• Light Cardio (30 min)<br/>• Flexibility (30 min)<br/>• Mental Training<br/>• Sinner Methods | Competition Specific<br/>• Match Practice (2h)<br/>• Situation Training<br/>• Power Tests Update<br/>• Strategy Sessions<br/>• Pressure Points | Tournament/Intensive<br/>• Competition Play<br/>• High Volume Day<br/>• Performance Testing<br/>• Recovery Between<br/>• Video Review | Rest & Review<br/>• Match Analysis<br/>• Recovery Focus<br/>• Week 8 Planning<br/>• Mental Reset |
| **Week 8 (Deload)** | Tactical Tennis & Recovery<br/>• Strategy Work<br/>• Light Weights<br/>• Mobility<br/>• Core | Technical Refinement<br/>• Serve Analysis<br/>• Light Upper<br/>• Flexibility<br/>• Recovery | Mental & Light Physical<br/>• Visualization<br/>• Easy Circuit<br/>• Yoga<br/>• Breathing | Recovery Focus<br/>• Massage<br/>• Light Swim<br/>• Stretching<br/>• Rest | Testing & Planning<br/>• Assessments<br/>• Video Review<br/>• Goal Adjust<br/>• Prep Week 9 | Light Play<br/>or Rest<br/>• Fun Tennis<br/>• Social<br/>• Recovery | Complete Rest<br/>• No Training<br/>• Mental Reset<br/>• Nutrition Focus |
| **Week 9** | Strength-Speed & Tennis<br/>• Power Baseline (90 min)<br/>• Heavy Complex (6 sets)<br/>• Jump Squats (5×3 @40%)<br/>• Speed Work (8×20m)<br/>• Peak RFD | Upper Power & Tennis<br/>• Serve Speed Max (90 min)<br/>• Bench Complex (6 sets)<br/>• Pull Power (5×3)<br/>• Rotational Power<br/>• VBT: 0.75-0.9 m/s | Competition Intensity<br/>• Match Sets (2h)<br/>• Power Endurance Test<br/>• React Drills (30 min)<br/>• Pressure Training<br/>• Mental Toughness | Skills & Recovery<br/>• Technical Polish (60 min)<br/>• Light Work (30 min)<br/>• Treatment Session<br/>• Mental Prep<br/>• Strategy Review | Peak Power & Tennis<br/>• All-Out Effort (90 min)<br/>• Max Tests (All)<br/>• Record PRs:<br/>• - Serve, Jump, Sprint<br/>• Competition Ready | High-Level Match<br/>• Tournament Play<br/>• Peak Performance<br/>• Record All Stats<br/>• Video Analysis<br/>• Recovery Focus | Recovery<br/>• Light Activity (30 min)<br/>• Phase Assessment<br/>• Week 10-12 Prep<br/>• Taper Planning |

### Phase 4: Championship Peaking (Weeks 10-12)

| Week | Monday | Tuesday | Wednesday | Thursday | Friday | Saturday | Sunday |
|------|---------|---------|-----------|----------|---------|----------|---------|
| **Week 10** | Speed Focus & Tennis<br/>• Lightning Drills (75 min)<br/>• Speed Training (10×10m)<br/>• Light Loads (40-50%)<br/>• Fast Reps (>1.2 m/s)<br/>• Neural Speed | Neural Speed & Tennis<br/>• Serve Precision (75 min)<br/>• Speed Work (6 sets)<br/>• Light Upper (3×5 @50%)<br/>• Quick Hands Drills<br/>• Reaction Time | Competition Sharp<br/>• Match Points (90 min)<br/>• Pressure Drills (30 min)<br/>• Speed Endurance<br/>• Mental Edge Work<br/>• Clutch Training | Recovery & Touch<br/>• Feel Work (45 min)<br/>• Light Cardio (20 min)<br/>• Treatment Session<br/>• Visualization (20 min)<br/>• Taper Protocol | Pre-Competition<br/>• Light Intensity (60 min)<br/>• CNS Activation<br/>• Strategy Review<br/>• Mental Prep (30 min)<br/>• Equipment Ready | Competition/Simulation<br/>• Tournament Play<br/>• Peak Focus Mode<br/>• Execute Game Plan<br/>• Maintain Intensity<br/>• Recovery Between | Active Recovery<br/>• Light Tennis (30 min)<br/>• Match Analysis<br/>• Week 11 Planning<br/>• Massage Therapy |
| **Week 11 (Taper)** | Neural Priming & Tennis<br/>• Sharp Drills (60 min)<br/>• Light Power (3×3 @40%)<br/>• Speed Focus (5×10m)<br/>• Feel Work (30 min)<br/>•30% Volume | Maintain & Sharpen<br/>• Serve Tune (45 min)<br/>• Light Upper (2×5 @40%)<br/>• Speed Drills (5 sets)<br/>• Recovery Focus<br/>• Neural Fresh | Competition Ready<br/>• Match Situations (60 min)<br/>• Short Bursts (10-15s)<br/>• Mental Work (30 min)<br/>• Confidence Building<br/>• Peak Readiness | Light & Technical<br/>• Touch Work (30 min)<br/>• Easy Movement<br/>• Treatment Session<br/>• Full Rest Priority<br/>• Sleep 9+ hours | Final Prep<br/>• Light Tennis (30 min)<br/>• Activation (15 min)<br/>• Visualization (20 min)<br/>• 100% Ready<br/>• Equipment Check | Major Competition<br/>• Championship Event<br/>• Peak Performance<br/>• Execute Strategy<br/>• Mental Strength<br/>• Breakthrough | Recovery<br/>• Celebration<br/>• Light Activity<br/>• Reflection<br/>• Future Planning |
| **Week 12** | Championship Week<br/>• Competition Prep (45 min)<br/>• Light Work (20 min)<br/>• Mental Ready (30 min)<br/>• Activation Protocol<br/>• Minimal Volume | Competition Day -3<br/>• Final Tune (30 min)<br/>• Light Drills (20 min)<br/>• Rest Focus Priority<br/>• Mental Prep (20 min)<br/>• Hydration Focus | Competition Day -2<br/>• Activation (15 min)<br/>• Feel Work (20 min)<br/>• Strategy Review<br/>• Maximum Rest<br/>• Nutrition Timing | Competition Day -1<br/>• Final Prep (20 min)<br/>• Light Hit (15 min)<br/>• Mental Ready<br/>• Early Rest (9pm)<br/>• Pre-Competition Meal | Competition Day<br/>• Alcaraz Warm-up (20 min)<br/>• **CHAMPIONSHIP**<br/>• Execute Elite Plan<br/>• Peak Performance<br/>• Career Breakthrough | Competition/Recovery<br/>• Continue Event<br/>or Full Recovery<br/>• Celebrate Success<br/>• Ice Bath/Massage<br/>• Nutrition Recovery | Season Review<br/>• Complete Rest<br/>• Performance Analysis<br/>• 2025 Planning<br/>• 4-Week Recovery |

## Key Training Themes by Week

| Week | Primary Focus | Training Emphasis | Volume | Intensity | Weekly Load |
|------|--------------|-------------------|---------|-----------|-------------|
| 1 | Elite Foundation | Movement Quality, Base Building | Moderate (100%) | Low-Moderate (60-70%) | 420 AU |
