...
import workoutData from '@site/workout-data/week-2/monday.yml';
...
<WorkoutCarouselFromData week={2} day="monday" />
...
<StabilityPowerBlock data={workoutData.strength_training?.stability_strength_block} />
